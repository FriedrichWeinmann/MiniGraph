...
Remove-Module MiniGraph -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\MiniGraph\MiniGraph.psd1"
Import-Module "$PSScriptRoot\..\MiniGraph\MiniGraph.psm1" -Force
