...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\MiniGraph\functions", "$global:testroot\..\MiniGraph\internal\functions"),
	
	[string]
	$ModuleName = "MiniGraph",
...
$CommandPath = @(
    "$global:testroot\..\MiniGraph\functions"
    "$global:testroot\..\MiniGraph\internal\functions"
)
